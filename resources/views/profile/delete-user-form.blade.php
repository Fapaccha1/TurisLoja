...
<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('¿Está seguro de que desea eliminar su cuenta? Una vez eliminada la cuenta, todos sus recursos y datos se eliminarán de forma permanente. Introduzca su contraseña para confirmar que desea eliminar su cuenta de forma permanente.') }}
